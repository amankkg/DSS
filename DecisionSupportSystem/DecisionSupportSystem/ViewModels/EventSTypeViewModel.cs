...
{
    public class EventSTypeViewModel : BasePropertyChanged, IDataErrorInfo
    {
        public EventSTypeViewModel(Event ev, EventListSTypeViewModel eventListViewModel)
        {
        ...
        public EventSTypeViewModel(EventListSTypeViewModel eventListViewModel)
        {
            var ev = new Event(); 
            this.EventListViewModel = eventListViewModel;
            this.Name = ev.Name;
        ...
        public EventListSTypeViewModel EventListViewModel { get; set; }
